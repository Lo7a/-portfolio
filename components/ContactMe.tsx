      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-2xl">054-3032273</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">Afula Sapir 4/19</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">Lahavk7@gmail.com</p>
          </div>
        </div>
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#F7AB0A]/75 py-5 px-10 rounded-md text-black font-bold text-lg "
          >
            Submit
          </button>
        </form>
